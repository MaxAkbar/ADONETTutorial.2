...
namespace ADONETTutorial
{
    public class WorkingWithSqlConnection
    {
        ...
        public static void SqlConnectionExample()
        {
            ...
            sqlConnection.InfoMessage += conn_InfoMessage;

            sqlConnection.Open();

            // Get the Meta Data for Supported Schema Collections
            DataTable metaDataTable = sqlConnection.GetSchema("MetaDataCollections");
            ...
            DataTable databasesSchemaTable = sqlConnection.GetSchema("Databases");
            ...
            DataTable courseTableSchemaTable = sqlConnection.GetSchema("Tables", tableRestrictions);
            ...
            DataTable departmentIDSchemaTable = sqlConnection.GetSchema("Columns", columnRestrictions);
            ...
            DataTable allIndexColumnsSchemaTable = sqlConnection.GetSchema("IndexColumns");
            ...
            DataTable courseIdIndexSchemaTable = sqlConnection.GetSchema("IndexColumns", indexColumnsRestrictions);
